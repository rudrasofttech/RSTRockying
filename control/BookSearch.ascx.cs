    ...
    protected void SearchButton_Click(object sender, EventArgs e)
    {
        try {
            ...
            using (WebClient client = new WebClient())
            {
                ...
                Stream data = client.OpenRead("https://www.googleapis.com/books/v1/volumes?q=" + SearchKeywordTextBox.Text.Trim() + "&key=AIzaSyDk_69U0aUGJ8S5TdeVueLIDwApc6zxQ5w");
            ...
            Trace.Warn("Book search giving error.");
